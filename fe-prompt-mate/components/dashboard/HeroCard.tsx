        ...
        >
            ...
            <div className="flex h-full flex-col justify-between">
                <div className="pt-[8px]">
                    <SparkleIcon />
                    <h2 className="mt-[18px] text-[22px] font-bold leading-[1.35] text-[#2B2B2B]">
                        말 안듣는 AI 때문에
                        <br />
                        답답하신가요?
                    </h2>
                    <p className="mt-[10px] text-[14px] font-medium leading-[1.55] text-[#6B7280]">
                        내 프롬프트를 점검해보고,
                        <br />
                        더 나은 AI 결과물을 얻어보세요.
                    </p>
                ...
                <div className="pb-[6px]">
                    <button
                        className={[
                            ...
                            "bg-[linear-gradient(180deg,#6D5EF6_0%,#5B4DF2_100%)]",
                            "text-[14px] font-semibold text-white",
                            "shadow-[0_12px_30px_rgba(93,83,255,0.30)]",
